...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_dir', default='/home/tiger/nfs/xx/deblur/LMD-ViT-NIPS/gopro_sharp_results/results', type=str, help='Directory for results')
    parser.add_argument('--ckpt_path', default='./ckpt/model_160000.pth', type=str, help='Path to weights')
